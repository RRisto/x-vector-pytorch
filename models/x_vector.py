...
class X_vector(nn.Module):
    def __init__(self, input_dim = 40, num_classes=8):
        ...
        self.tdnn1 = TDNN(input_channels=input_dim, output_channels=512, context=[-2,2])
        self.tdnn2 = TDNN(input_channels=512, output_channels=512, context=[-2, 0, 2])
        self.tdnn3 = TDNN(input_channels=512, output_channels=512, context=[-3, 0,3])
        self.tdnn4 = TDNN(input_channels=512, output_channels=512, context=[0])
        self.tdnn5 = TDNN(input_channels=512, output_channels=512, context=[0])
        #### Frame levelPooling
